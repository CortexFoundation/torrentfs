...
func (fs *ChainDB) initMerkleTree() error {
	...
	fs.leaves = nil
	fs.leaves = append(fs.leaves, merkletree.BlockContent{X: params.MainnetGenesisHash.String()}) //"0x21d6ce908e2d1464bd74bbdbf7249845493cc1ba10460758169b978e187762c1"})
...
func (fs *ChainDB) addLeaf(block *types.Block, mes bool, dup bool) error {
	number := block.Number
	leaf := merkletree.BlockContent{X: block.Hash.String(), N: number}
